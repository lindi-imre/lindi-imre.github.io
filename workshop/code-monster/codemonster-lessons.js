...
var lessons =
	[
		...
		// Draw box
		{ message: "I'm Codecool! (click on my words to see what's next)", 
		...
		// Variables
		{ message: "Codecool like boxes square.", 
		...
		// More boxes
		{ message: "Codecool want two boxes.", 
		...
		{ message: "Codecool want more boxes.  Three boxes!", 
		...
		{ message: "Let's go back to variables. Codecool no like to repeat numbers. Can you replace both the 20 numbers with <span class=tutor-code>offset</span>?",
		  code: "var offset = 30;\nvar size = 80;\nc.fillStyle =\"lime\";\nc.fillRect(20, 20, size, size);\nc.fillRect(90, 90, size, size);\n",
		...
		{ message: "Codecool like adding.  Me add good.  Okay, now try changing <span class=tutor-code>offset</span> from 30 to 80.  See what happens?",
		  code: "var offset = 30;\nvar size = 80;\nc.fillStyle =\"lime\";\nc.fillRect(offset, offset, size, size);\noffset = offset + 60;\nc.fillRect(offset, offset, size, size);\n"
		},
		...
		{ message: "Remember rgba()?  Codecool like.  Can you make me three boxes with different colors?",
		  code: "var size = 80;\nvar offset = 20;\n\nc.fillStyle =\"rgba(0, 0, 255, 0.5)\";\nc.fillRect(offset, offset, size, size);\noffset = offset + 60;\nc.fillStyle =\"rgba(0, 0, 255, 0.5)\";\nc.fillRect(offset, offset, size, size);\noffset = offset + 60;\nc.fillStyle =\"rgba(0, 0, 255, 0.5)\";\nc.fillRect(offset, offset, size, size);\n"
		},
		...
		{ message: "Codecool no like writing code more than once.  Lots of writing the same code more than once here, me not like.",
		  code: "var size = 80;\nvar offset = 20;\n\nc.fillStyle =\"blue\";\n\nc.fillRect(offset, offset, size, size);\noffset = offset + 40;\nc.fillRect(offset, offset, size, size);\noffset = offset + 40;\nc.fillRect(offset, offset, size, size);\n",
		...
		// Draw line
		{ message: "Codecool draw line. What do you think moveTo() does? lineTo()? Try changing 20 to 50.",
		  code: "c.beginPath();\nc.moveTo(30, 20);\nc.lineTo(120, 40);\nc.stroke();\n",
		  lessonSection: "Lines",
		},
		...
		{ message: "I know!  Use for loop!  Can you make more boxes for Code Codecool?",
		...
		{ message: "Code Codecool no like repeating self.  No like.  No like.  For loops avoid repeating.  Me now show you functions too. Functions also avoid repeating.",
		  code: "// All work and no play\n// make Codecool a dull boy\n// All work and no play\n// make Codecool a dull boy\n// All work and no play\n// make Codecool a dull boy\n",
		...
		// Fan curves
		{ message: "When me little Codecool, me draw these.  You like too?  Change number of lines!",
		  code: "var num = 10;\nvar w = c.canvas.width;\nvar h = c.canvas.height;\n\nfor (var i = 0; i < num; i = i + 1) {\n  var x = i * w / (num - 1);\n  var y = i * h / (num - 1);\n  drawLine(0, y, x, h);\n}\n\nfunction drawLine(x1, y1, x2, y2) {\n  c.beginPath();\n  c.moveTo(x1, y1);\n  c.lineTo(x2, y2);\n  c.stroke();\n}\n",
		...
		{ message: "There are a couple new things here.  Codecool stop to explain."},
		...
		{ message: "You know, Codecool has a secret.  Codecool been hiding something from you.",
		...
		{ message: "Codecool added some code for you to get that object from the web page and put it in a variable named <span class=tutor-code>c</span>, so you could use it.  Let me show you what that hidden code looks like.",
		...
		{ message: "A big new thing here.  Codecool explain.",
		},
		...
		{ message: "All those fast spinning boxes make Codecool dizzy.  Let's slow it down again and let me show you something else.  We can move the update into each Box object.  That will be handy when we make the update do more.  See what this does now?",
